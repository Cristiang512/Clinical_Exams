            ...
            @if(Session::has('mensaje'))
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{url('service/create')}}" class="btn btn-success">Agregar Servicio</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              {{-- style="border-right: 1px solid gray;border-left: 1px solid gray;border-top: 1px solid gray;border-bottom: 1px solid gray" --}}
                                <p class="text-center"> <strong>Lista de Servicios</strong> </p>
                                <div class="chart">
                                    <table class="table table-light" id="service">
